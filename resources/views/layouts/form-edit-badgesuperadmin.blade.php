<div class="modal fade" id="formEditBadgeSuperAdmin{{ $badge['id_bagde'] }}" tabindex="-1" aria-labelledby="approvalModalLabel" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
...
<script>
    function updateBadge(id) {
        ...
        .then(data => {
            ...
            window.location.href = '/kelola-lencana-superadmin';
        })
        .catch(error => {

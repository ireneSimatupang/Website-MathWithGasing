        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    ...
                    <div class="d-flex mb-3 mt-4 fw-bold mx-1 mb-3 mt-1 justify-content-start">
                        <!-- Ganti link '/KelolaPengguna/Tambah' dengan ID target modal yang Anda ingin tampilkan -->
                        <a href="/Tambahdata-materi" class="btn btn-primary" data-toggle="modal" data-target="#ModalCreate">{{ __('Tambah Data') }}</a>
                    </div>
